...
You will help me by summarizing new articles I give you in several languages.
"""
...
def generate_prompt(article: str):
    ...
    please don't just translate the summary from the original language. But do get the summary in the target language by 
